...
> **Bard 15 (College of Lore)** · Mark of Shadow Elf · Criminal Background  
...
|Skill                    |Mod    |Note                             |
|-------------------------|-------|---------------------------------|
|**Acrobatics (DEX)**     |**+5** |Proficient (+ Jack of All Trades)|
|Animal Handling (WIS)    |+2     |Jack of All Trades               |
|**Arcana (INT)**         |**+6** |Proficient                       |
|Athletics (STR)          |+1     |Jack of All Trades               |
|**Deception (CHA)**      |**+10**|Proficient                       |
|**History (INT)**        |**+6** |Proficient                       |
|Insight (WIS)            |+2     |Jack of All Trades               |
|**Intimidation (CHA)**   |**+7** |Proficient                       |
|**Investigation (INT)**  |**+6** |Proficient                       |
|Medicine (WIS)           |+2     |Jack of All Trades               |
|Nature (INT)             |+3     |Jack of All Trades               |
|**Perception (WIS)**     |**+10**|Expertise ⭐                      |
|**Performance (CHA)**    |**+15**|Expertise ⭐                      |
|**Persuasion (CHA)**     |**+10**|Proficient                       |
|**Religion (INT)**       |**+3** |Proficient                       |
|**Sleight of Hand (DEX)**|**+18**|Expertise ⭐                      |
|**Stealth (DEX)**        |**+13**|Expertise ⭐                      |
|Survival (WIS)           |+2     |Jack of All Trades               |
|**Thieves’ Tools (DEX)** |**+13**|Expertise ⭐                      |
...
- **Armor:** Light Armor
- **Weapons:** Crossbow, Hand Crossbow, Longsword, Rapier, Shortsword, Simple Weapons
- **Tools:** Flute, Harp, Lyre, Thieves’ Tools
...
|---------------------|---|--------------|-------------------------------------------------------------------------------|
|Dagger               |+8 |1d4+3 piercing|Simple, Finesse, Light, Thrown, Nick, Range (20/60). True Strike: 2d6+5 radiant|
|Rapier +3 true strike|+13|1d8+8 piercing|Martial, Finesse, Vex. True Strike: 2d6+5 radiant                              |
|Rapier, +3           |+11|1d8+6 piercing|Martial, Finesse, Vex. True Strike: 2d6+5 radiant                              |
...
|Studded Leather, +2          |1  |13 lb |
|Potion of Healing (Greater)  |3  |1.5 lb|
|Potion of Healing (Superior) |2  |1 lb  |
|Potion of Healing (Supreme)  |0  |—     |
|Gift of Alacrity             |1  |—     |
|Rapier +3 true strike        |1  |2 lb  |
|Gloves of Thievery           |1  |—     |
|Protection from Energy       |1  |—     |
|Shard of the Ise Rune (boots)|1  |—     |
|Harper Pin rank 4            |1  |—     |
|Backpack                     |1  |5 lb  |
|Dagger                       |1  |1 lb  |
...
- Detect Magic [R]
- Cure Wounds
- Detect Magic *(Wand of Magic Detection)*
- Magic Missile *(Wand of Magic Missiles)*
- Protection from Evil and Good *(Anstruth Harp)*

### Level 2 — 3 slots

- Lesser Restoration
- Levitate *(Anstruth Harp)*
- Invisibility *(Anstruth Harp)*
- Invisibility *(Shape Shadows — 1/Long Rest)*
...
- Counterspell
- Dispel Magic
- Sleet Storm *(Shard of the Ise Rune)*
- Fly *(Anstruth Harp)*
- Mass Healing Word *(Magical Discoveries)*
- Spirit Guardians *(Magical Discoveries)*

### Level 4 — 3 slots

- Dimension Door
- Greater Invisibility
- Ice Storm *(Anstruth Harp)*

### Level 5 — 2 slots

- Dominate Person
- Greater Restoration
- Cure Wounds *(Anstruth Harp)*

### Level 6 — 1 slot

- Chain Lightning
- Disintegrate
- Wall of Thorns *(Anstruth Harp)*
...
**Personality Trait:** I don’t pay attention to the risks in a situation. Never tell me the odds. The first thing I do in a new place is note the locations of everything.
