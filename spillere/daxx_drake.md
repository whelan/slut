...
> **Ranger 15 (Hunter)** · Changeling · Soldier Background  
...
|**Initiative**           |+5                                 |—               |
|**Speed**                |40 ft (Walking, Climbing, Swimming)|—               |
|**Proficiency Bonus**    |+5                                 |—               |
|**Spell Save DC**        |15                                 |—               |
...
|**Animal Handling (WIS)**|**+7** |Proficient |
|Arcana (INT)             |+1     |           |
|**Athletics (STR)**      |**+4** |Proficient |
|Deception (CHA)          |+0     |           |
|History (INT)            |+1     |           |
|**Insight (WIS)**        |**+12**|Expertise ⭐|
|**Intimidation (CHA)**   |**+5** |Proficient |
|**Investigation (INT)**  |**+11**|Expertise ⭐|
|Medicine (WIS)           |+2     |           |
|Nature (INT)             |+1     |           |
|Perception (WIS)         |+2     |           |
|Performance (CHA)        |+0     |           |
...
- **Weapons:** Longbow, Martial Weapons, Shortsword, Simple Weapons
- **Tools:** Dice Set
- **Languages:** Common, Draconic, Druidic, Dwarvish, Elvish, Orc
...
|---------------------|---|--------------|--------------------------------------------------------------------|
|Dagger               |+10|1d4+5 piercing|Simple, Finesse, Light, Thrown, Nick, Range (20/60)                 |
|Dart                 |+12|1d4+5 piercing|Simple, Finesse, Thrown, Vex, Range (20/60)                         |
|Dragon Slayer Longbow|+13|1d8+6 piercing|Martial, Ammunition, Heavy, Range, Two-Handed, Slow, Range (150/600)|
|Dragon Wing Longbow  |+12|1d8+5 piercing|                                                                    |
|Dragontooth Dagger   |+11|1d4+6 piercing|+1d6 acid, Simple, Finesse, Light, Thrown, Nick, Range (20/60)      |
|Frost Brand Scimitar |+10|1d6+5 slashing|+1d6 cold, Martial, Finesse, Light, Nick                            |
...
|Scimitar of Speed                    |1  |3 lb  |
|Frost Brand Scimitar                 |1  |3 lb  |
|Potion of Healing (Greater)          |3  |1.5 lb|
|Potion of Healing (Superior)         |2  |1 lb  |
|Quiver of Ehlonna                    |1  |2 lb  |
|Dragontooth Dagger                   |1  |1 lb  |
|Dragon Wing Longbow                  |1  |2 lb  |
|Potion of Healing                    |4  |2 lb  |
|Dragon Scale Mail (Gold)             |1  |45 lb |
...
- **The Emerald Enclave**
- **Harpers** — Remallia Haventree
- **Order of the Gauntlet** — Ontharr Frume
- **Emerald Enclave** — Delaan Winterhound (= Daxx)
