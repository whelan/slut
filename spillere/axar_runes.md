...
> **Wizard 15 (Evoker)** · Dwarf · Sage Background  
> *Nickname: Silver Face*  
> Player: WhelanDk · XP: 165,000
...
|**Arcana (INT)**       |**+15**|Expertise ⭐|
|Athletics (STR)        |−1     |           |
|Deception (CHA)        |+0     |           |
|**History (INT)**      |**+10**|Proficient |
|**Insight (WIS)**      |**+7** |Proficient |
|Intimidation (CHA)     |+0     |           |
|**Investigation (INT)**|**+10**|Proficient |
|Medicine (WIS)         |+2     |           |
|**Nature (INT)**       |**+10**|Proficient |
|Perception (WIS)       |+2     |           |
|Performance (CHA)      |+0     |           |
|Persuasion (CHA)       |+0     |           |
|**Religion (INT)**     |**+5** |Proficient |
|Sleight of Hand (DEX)  |+1     |           |
|Stealth (DEX)          |+1     |           |
|Survival (WIS)         |+2     |           |
|**Mason’s Tools (INT)**|**+10**|Proficient |
...
|---------------|---|--------------|---------------------------------------------------------------------------|
|Dagger of Venom|+7 |1d4+2 piercing|+2d10 poison, 1 charge, Simple, Finesse, Light, Thrown, Nick, Range (20/60)|
|Fire Bolt      |+10|3d10 fire     |V/S                                                                        |
|Shocking Grasp |+10|3d8 lightning |V/S                                                                        |
|Ray of Frost   |+10|3d8 cold      |V/S                                                                        |
|Unarmed Strike |+4 |0 bludgeoning |                                                                           |
...
|Goggles of Night                         |1  |—     |
|Handy Haversack                          |1  |5 lb  |
|Potion of Heroism                        |1  |—     |
|Potion of Healing (Greater)              |5  |2.5 lb|
|Potion of Healing (Superior)             |0  |—     |
|Potion of Fire Resistance                |1  |—     |
|Levitate (scroll)                        |1  |—     |
|Scroll of Protection: Elementals (Earth) |1  |—     |
|Scroll of Protection: Elementals (Fire)  |2  |—     |
|Scroll of Protection: Aberrations        |1  |—     |
|Clockwork Amulet                         |1  |—     |
|Dragon-Touched Focus (Wakened)           |1  |—     |
|Harper Pin                               |1  |—     |
|Spell Scroll (Level 1)                   |1  |—     |
|Hat of Many Spells                       |1  |—     |
|Book of Exalted Deeds                    |1  |—     |
|Component Pouch                          |1  |2 lb  |
|Clothes, Traveler’s                      |1  |4 lb  |
|Potion of Healing                        |4  |2 lb  |
|Figurine of Wondrous Power (Golden Lions)|1  |—     |
|Rod of Alertness                         |1  |—     |
|Dagger of Venom                          |1  |1 lb  |
|Gems of Misty Step                       |2  |—     |
...
- Elementalism *(Magic Initiate)*

### Level 1 — 4 slots

Burning Hands, Detect Magic [R], Comprehend Languages [R], Feather Fall, Find Familiar [R], Mage Armor, Identify [R], Jim’s Magic Missile, Protection from Evil and Good, Shield, Sleep, Alarm [R], Absorb Elements, Thunderwave, Disguise Self, Magic Missile, Detect Evil and Good *(Rod)*, Detect Poison and Disease *(Rod)*, Detect Magic *(Rod)*, Mage Armor *(Magic Initiate)*, Chromatic Orb *(Evocation Savant)*, Burning Hands *(Evocation Savant)*

### Level 2 — 3 slots

Enlarge/Reduce, Flaming Sphere, Hold Person, Levitate, Misty Step, Scorching Ray, Shatter, Rime’s Binding Ice, Continual Flame, Detect Thoughts, Darkvision, Mirror Image, Suggestion, Rime’s Binding Ice *(Dragon-Touched Focus)*, See Invisibility *(Rod)*

### Level 3 — 3 slots

Counterspell, Dispel Magic, Fireball, Fly, Glyph of Warding, Leomund’s Tiny Hut [R], Life Transference, Magic Circle, Sending, Tongues, Water Breathing [R], Vampiric Touch, Lightning Bolt

### Level 4 — 3 slots

Banishment, Confusion, Fire Shield, Polymorph, Raulothim’s Psychic Lance, Wall of Fire, Arcane Eye, Ice Storm, Raulothim’s Psychic Lance *(Dragon-Touched Focus)*

### Level 5 — 2 slots

Bigby’s Hand, Conjure Elemental, Creation, Legend Lore, Telekinesis, Teleportation Circle, Cone of Cold, Scrying, Wall of Force, Hold Monster *(Dragon-Touched Focus)*, Legend Lore *(Dragon-Touched Focus)*, Rary’s Telepathic Bond *(Dragon-Touched Focus)*

### Level 6 — 1 slot

Chain Lightning, Disintegrate, True Seeing, Globe of Invulnerability, Sunbeam, Fizban’s Platinum Shield *(Dragon-Touched Focus)*

### Level 7 — 1 slot

Prismatic Spray, Whirlwind, Teleport, Simulacrum

### Level 8 — 1 slot

Holy Star of Mystra, Sunburst
...
- **Harpers** — Characters might have heard of the older Harpers, but they’re unlikely to know much about the secretive group beyond…
